...
export const userAuthenication = (email, password, mode) => dispatch => {
    ...
    let url = ""
    if (mode == 'signup') {
        url = "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyA37lcNvd3JQ0D_QvdR0ZY7x6WeFqgz8_E"
        // url = "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAy2JQq0CeBf9Kchv1-tnQLx4B0_8W0pps"
    }
    else {
        url = "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyA37lcNvd3JQ0D_QvdR0ZY7x6WeFqgz8_E"
    }
...
export const post_account_to_database = (account) => dispatch => {
    axios.post("https://finance-app-react-native-default-rtdb.firebaseio.com/accounts.json", account)
        .then(res => res)
...
export const get_accounts_from_database = () => dispatch => {
    ...
    axios.get(`https://finance-app-react-native-default-rtdb.firebaseio.com/accounts.json`)
