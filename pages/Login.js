...
const Login = (props) => {
    ...
    return (
        <View style={{ width: '90%', flex: 1, justifyContent: 'center', alignItems: 'center' }}>
            <TouchableOpacity style={{ width: 300, height: 30, justifyContent: 'center', backgroundColor: '#800020', alignItems: 'center' }} onPress={handelMode} >
            ...
            <TouchableOpacity style={{ width: 100, height: 30, backgroundColor: '#800020', justifyContent: 'center', alignItems: 'center', marginTop: 5, borderRadius: 4 }} onPress={() => submitFormData()}>
